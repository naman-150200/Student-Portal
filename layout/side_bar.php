...
?>
        ...
        <img class="img_style"  width="74" hieght="70" src="<?php echo"$photo"; ?>">
                ...
                <?php if($user_permit<8){ ?>
                    ...
                    <li><a href="javascript:void(0)" data-target=".result" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-th-list side_bar_icon"></i> Exam (Beta)<i class="fa fa-collapse"></i></a></li>
                    ...
                    <li>
                        <ul class="notice nav nav-list collapse">
                            ...
                            <li><a href="notice_list.php"><span class="fa fa-caret-right"></span>Notice List <small>(Beta)</small></a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="javascript:void(0)" data-target=".sms" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-envelope-o side_bar_icon"></i> SMS <small>(Beta) </small><i class="fa fa-collapse"></i></a></li>

                    <li>
                        <ul class="sms nav nav-list collapse">
                            <li><a href="sms_dashboard.php" class="l_active"><span class="fa fa-caret-right"></span>SMS/Email Dashboard <small>(Beta)</small></a></li>
