                        ...
                        <div class="circle-tile">
                            <a href="">
                                <div class="circle-tile-heading dark-blue">
                                    <img src="Final_Logo_IIITL.png" class="logo_img">
                                </div>
                            </a>
                            <div class="circle-tile-content dark-blue">
                                <center>
                                <div class="description_area">
                                  <font class="site_title">IIIT Lucknow</font><br/>
                                      <font class="site_description">
                                        <span class="glyphicon glyphicon-map-marker"></span> IIIT Lucknow
Chak Ganjaria, C. G. City
Lucknow – 226002<br/>
                                        <span class="glyphicon glyphicon-phone"></span> Phone:1234567890 | <span class="glyphicon glyphicon-envelope"></span> Email: contact@iiitl.ac.in
                                  </font>
                                </div>
                              </center>
