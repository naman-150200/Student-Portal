...
?>
  <div class="school_header_area">    
      <span class="school_title">IIIT Lucknow</span><br/>
      <span class="glyphicon glyphicon-map-marker"></span> <?php echo $this->db->address;?><br/>
      <span class="glyphicon glyphicon-phone"></span> Phone: 1234567890 | <span class="glyphicon glyphicon-envelope"></span> Email:contact@iiitl.ac.in  </div>
    <style type="text/css">
      .school_header_area{
      text-align: center;
      font-size: 14px; 
